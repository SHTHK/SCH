                ...
                {groupChars.map((char) => (
                  ...
                  >
                    <div className="w-full aspect-square bg-slate-100 overflow-hidden relative">
                      <img
                        src={char.squareImageUrl ? `${import.meta.env.BASE_URL}${char.squareImageUrl.replace(/^\//, '')}` : `https://placehold.co/400x400/1e293b/ffffff?text=${encodeURIComponent(char.name)}`}
                        alt={char.name}
